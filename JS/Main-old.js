...
function Main() {
	...
	lv2bgImg.src = 'img/galaxy.jpg';
	lv2bgImg.name = 'lv2bg';
	// lv2bgImg.onload = loadGfx;
	lv2bg2Img.src = 'img/galaxy.jpg';
	lv2bg2Img.name = 'lv2bg2';
	// lv2bg2Img.onload = loadGfx;

	lv2prImg.src = 'img/bg.png';
	lv2prImg.name = 'lv2pr';
	// lv2prImg.onload = loadGfx;
	lv2pr2Img.src = 'img/bg.png';
...
function level_2() {
	...
	// bg.graphics.beginBitmapFill(lv2bgImg, 'repeat').drawRect(0, 0, canvas.width, canvas.height);
	// bg2 = new Shape();
	// bg2.graphics.beginBitmapFill(lv2bgImg, 'repeat').drawRect(0, 0, canvas.width, canvas.height);
	// Tween.get(bg).to({ alpha: 1, visible: true }, 1000);
	// Tween.get(bg2).to({ alpha: 1, visible: true }, 1000);
